...
const TracksPage = () => {
  // Note: 't' can be used for internationalization if configured, otherwise hardcoded strings.
    ...
    <div className="py-12 bg-background min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="heading-xl text-primary mb-2">Learning Tracks</h1>
        ...
        <div className="mb-6 flex items-center justify-between">
          <p className="body-sm text-text-muted">
            {isLoading ? "Loading..." : `Showing ${tracks.length} results`}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
            ...
            <div className="col-span-full text-center py-20">
              <p className="heading-m text-text-muted">No tracks found.</p>
              <Button
                variant="outline"
                className="mt-4"
                onClick={() => setSearch("")}
