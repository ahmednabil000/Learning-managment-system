...
const trackValidator = require("../validations/trackValidator");
...
exports.getTracks = async (req, res) => {
    try {
        ...
        const { tracks, totalItems, totalPages } =
            await trackService.getTracks(page, pageCount, search);
...
exports.createTrack = async (req, res) => {
    try {
        const { title, description, coverImage, duration, isPublished, instructor, courses } =
...
exports.updateTrackById = async (req, res) => {
    try {
        ...
        const track = await trackService.updateTrackById(
            req.params.id,
            {
                title,
                description,
